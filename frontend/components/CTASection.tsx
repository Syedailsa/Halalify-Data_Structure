...
export default function CTASection() {
  ...
  return (
    <section ref={ref} className="cta-section" style={{ position: "relative", paddingTop: "clamp(36px,6vw,55px)" }}>
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "0 clamp(1.25rem,5vw,2rem)", textAlign: "center", position: "relative", zIndex: 1 }}>
        {/* Badge */}
        <div className="reveal" style={{ transitionDelay: "0ms", marginBottom: "1.25rem" }}>
          <span style={{ fontSize: "0.68rem", fontWeight: 700, letterSpacing: "0.12em", textTransform: "uppercase", color: "rgba(255,255,255,0.6)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 999, padding: "6px 16px", display: "inline-block" }}>
        ...
        {/* Headline */}
        <div className="reveal" style={{ transitionDelay: "100ms", marginBottom: "1rem" }}>
          <h2 style={{ fontSize: "clamp(1.8rem,5vw,2.5rem)", fontWeight: 900, color: "#fff", lineHeight: 1.1, letterSpacing: "-0.025em" }}>
            Start Verifying Your Food Today
          </h2>
        </div>
        ...
        {/* Sub */}
        <div className="reveal" style={{ transitionDelay: "200ms", marginBottom: "2.5rem" }}>
          <p style={{ color: "rgba(255,255,255,0.55)", fontSize: "clamp(0.85rem,2.5vw,0.95rem)" }}>
            Join thousands of users making informed halal choices every day
          </p>
        </div>

        {/* Store buttons */}
        <div className="reveal cta-store-row" style={{ transitionDelay: "300ms", display: "flex", justifyContent: "center", gap: "1rem", flexWrap: "wrap", marginBottom: "3rem" }}>
          {[
            { icon: "🍎", top: "Download on the", bottom: "App Store" },
            { icon: "▶",  top: "GET IT ON",        bottom: "Google Play" },
          ].map(btn => (
        ...
        {/* Phone mockup */}
        <div className="reveal" style={{ transitionDelay: "400ms", display: "flex", justifyContent: "center", alignItems: "flex-end" }}>
          <Image
            src={hero}
            alt="Halalify UI"
            priority
      ...
      <style>{`
        @media (max-width: 480px) {
          ...
          .store-btn { width: 100%; max-width: 220px; justify-content: center; }
        }
      `}</style>
    </section>
  );
