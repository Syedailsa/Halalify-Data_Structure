      ...
      <div className="w-full max-w-md bg-white p-6 rounded-2xl shadow">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <input
            type="email"
            placeholder="Email"
            className="w-full border p-3 rounded cursor-text"
          />
          ...
          <button
            type="submit"
            className="w-full bg-green-600 text-white py-3 rounded-xl cursor-pointer hover:bg-green-700 transition"
          >
            {isLogin ? 'Sign In' : 'Create Account'}
          </button>
...
//     const hoverElements = document.querySelectorAll('button, input, a, .hover-glow')
//     hoverElements.forEach((el) => {
//       el.addEventListener('mouseenter', addHover)
//       el.addEventListener('mouseleave', removeHover)
//     })
...
//             <button
//               type="submit"
//               className="w-full bg-green-600 hover:bg-green-700 transition-all text-white py-3 rounded-xl font-semibold relative hover-glow overflow-hidden"
//             >
//               <span className="nav-glow" />
//               {isLogin ? 'Sign In' : 'Create Account'}
//             </button>
...
//           <button
//             type="submit"
//             className="w-full bg-green-600 hover:bg-green-700 transition-all text-white py-3 rounded-xl font-semibold"
//           >
//             {isLogin ? 'Sign In' : 'Create Account'}
//           </button>
