...
function loadENumbers(filePath) {
  ...
  return rows.map((r) => ({
    ...
    rawStatus: extractHalalStatus(r["Description"] || ""),
    soldIn: [],
    certBody: "HFCI India",
    certNum: null,
...
let allRecords = [
  ...loadENumbers(path.join(SOURCE_DIR, "halal_e_numbers_india.csv")),
...
console.log(`      (E-numbers: ${loadENumbers(path.join(SOURCE_DIR,"halal_e_numbers_india.csv")).length})`);
...
console.log(`  ✅  Loaded ${allRecords.length} raw records from 19 sources`);
// =============================================================================
